...
A clean, reproducible setup for running the [Floci](https://github.com/floci/floci) local AWS cloud emulator and web dashboard using Docker Compose, Makefile, and `mise`.
